...
export function AddNoteModal({ visible, onClose, onSubmit }: AddNoteModalProps) {
      ...
      <ThemedView style={styles.container}>
        ...
        >
          <View style={styles.header}>
            <ThemedText style={styles.headerTitle}>Add New Note</ThemedText>
          </View>
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              {loading ? (
                ...
                <ThemedText style={styles.submitButtonText}>Add Note</ThemedText>
              )}
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
